...
<template>
  <div>
    ...
    >
      ...
      <el-table-column sortable prop="deptName" label="用户名" width="300" />
      <el-table-column sortable prop="deptNo" label="手机号码" width="300" />
      <el-table-column
        sortable
        prop="editTime"
        label="已完成订单数"
      ...
      <el-table-column
        ...
        width="180"
      />
      <el-table-column sortable prop="startTime" label="加入时间" width="300" />
